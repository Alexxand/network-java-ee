...
<div class="container">
    <div class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            <h1 class="text-center login-title">Confirm email</h1>
            <div class="account-wall">
                <form class="form-signin" action="${contextPath}/reg/add-position" method="post">
                    <span class="help-block">We just sent the code to your email. Please, enter it in the field below.</span>
                    <input type="text" placeholder="Code" required="" class="form-control">
